                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="true">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="img/eskalasi.png" class="carouselimg d-block" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="img/marka.jpg" class="carouselimg d-block" alt="...">
                        </div>
                        <div class="carousel-item">
                            <img src="img/kisahmanis.jpg" class="carouselimg d-block" alt="...">
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card card-review" style="height: 45vh; background-color:rgb(247, 240, 231);">
                                <div class="scrollY">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-lg-2"> <a href="#"><img
                                                    src="https://img.icons8.com/bubbles/100/000000/lock-male-user.png"
                                                    class="align-self-center mr-1 imgreview"></a>
                                        </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <?php $time_stamp_dari_db = date('d-m-Y'); ?>
                                        <div class="col-lg">
                                            <p class="reply pe-2"><b>[nama orang]</b> <span
                                                    id="dtime"><?php echo $time_stamp_dari_db; ?></span><br>"Love
                                                this art,
                                                what inspired you to
                                                make
